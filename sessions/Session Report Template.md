...
session_window_start: "[[<% tp.date.now(\"YYYY-MM-DD\") %>]]"
session_window_end: "[[<% tp.date.now(\"YYYY-MM-DD\") %>]]"
project:
repo:
repo_slug:
repo_url:
...
- **Examples:**
  - `2026-04-24-session-report-obsidian-vault.md`
  - `2026-04-24-session-report-teneo-content-system.md`
- **Rule:** use lowercase, hyphens, no spaces, and stable slugs to stay aligned with the vault-wide naming conventions in `AGENTS.md`, `CLAUDE.md`, and `CODEX.md`.
...
- **Model(s):** [[GPT-5.4]]
- **Agent(s):** [[Codex]]
- **Relevant org / system links:** [[Github]], [[Teneo]], [[Metaverse Solutions]], [[Astraeus Business Solutions]], [[Gryps.Finance]], [[prompt-library]]
...
Add any of these if present and relevant:

- [[Teneo]]
- [[Metaverse Solutions]]
- [[Astraeus Business Solutions]]
- [[Gryps.Finance]]
- [[prompt-library]]
